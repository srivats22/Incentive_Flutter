...
class AddEditTask extends StatefulWidget {
  ...
  const AddEditTask(this.screenName, this.userUid, this.docId, this.taskName, this.taskDesc,
      this.taskReward, this.priority, this.isAdding, this.isPlanned);
    ...
    return SafeArea(
      child: Scaffold(
        appBar: AppBar(
          ...
          title: Text("${widget.screenName}", style: TextStyle(color: Colors.black),),
          ...
          child: SingleChildScrollView(
            ...
            child: Column(
              children: [
                ...
                SizedBox(height: 10,),
                Text("Low is selected by default",
                  ...
                  child: ButtonBar(
                    ...
                    children: [
                      ...
                      ElevatedButton(
                        ...
                        child: widget.isAdding ? Text("Add Task") : Text("Save"),
                      ),
                    ],
                  ),
                ),
  ...
  void submitForm(){
    if(!widget.isAdding){
      FirebaseFirestore.instance.collection("users")
          .doc("${widget.userUid}").collection("tasks")
          .doc("${widget.docId}")
          .update({
        "priority": priority,
